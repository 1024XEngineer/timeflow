  ...
  return (
    <AuthProvider controller={authController} invalidationCoordinator={invalidationCoordinator}>
      <AppServicesProvider services={services}>
        <AuthenticatedRuntime device={services.reminderPorts.device} runtime={services.runtime} />
        {children}
      </AppServicesProvider>
    </AuthProvider>
  );
...
function AuthenticatedRuntime({
  ...
  useReminderPermissionsOnLaunch(viewState.status === 'authenticated' ? device : null);
