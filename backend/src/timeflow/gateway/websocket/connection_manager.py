...
class ConnectionManager:
    ...
    async def stream_audio(
        ...
        Never waits for the whole reply: a producer that yields its first chunk early gets
        that chunk on the wire immediately, which is the only way time-to-first-audio can
        reflect how fast the producer actually is.
