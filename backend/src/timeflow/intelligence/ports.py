...
class ResultSink(Protocol):
    ...
    async def deliver_audio(
        ...
        Takes a stream rather than finished bytes so a producer can start speaking before it
        has finished generating. Returning means the reply was sent through to its end;
